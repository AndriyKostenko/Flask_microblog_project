...
from app import db
from app.forms import RegistrationForm, LoginForm, EditProfileForm, EmptyForm, PostForm, DeleteForm
...
def index():
    ...
    if form.validate_on_submit():
        post = Post(post_title=form.post_title.data, body=form.post.data, author=current_user)
        db.session.add(post)
        db.session.commit()
